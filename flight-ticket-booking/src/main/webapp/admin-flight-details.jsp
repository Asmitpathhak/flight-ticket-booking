	...
	<div>
		<table border="1">
			...
			<tr>
				...
				<td><a
					href="deleteFlight?flightNumber=<%=addFlight.getFlightNum()%>"><button>Delete</button></a></td>
				<td><a
					href="edit-flight.jsp?flightNumber=<%=addFlight.getFlightNum()%>"><button>Update</button></a></td>
			</tr>
			<%}}%>
			<%
			for (AdminAddFlight addFlight : addFlights) {
